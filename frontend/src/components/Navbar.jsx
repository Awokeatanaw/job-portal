          ...
          <div className="flex justify-between items-center h-16 md:h-20">
            ...
            <div className="hidden lg:flex items-center gap-6 xl:gap-8">
              {!user ? (
                ...
                <>
                  <Link to="/jobslist" className="flex items-center gap-2 text-base xl:text-lg font-semibold hover:text-indigo-600 transition"><Briefcase size={20} /> {t('jobs')}</Link>
                  <Link to="/companies" className="flex items-center gap-2 text-base xl:text-lg font-semibold hover:text-purple-600 transition"><Building2 size={20} /> {t('companies')}</Link>
                ...
                <>
                  <Link to="/post-job" className="px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-full font-bold shadow-lg hover:shadow-xl transition text-sm xl:text-base">{t('postJob')}</Link>
                  <Link to="/company-profile" className="flex items-center gap-2 text-base xl:text-lg font-semibold hover:text-purple-600 transition"><Building2 size={22} /> {t('companyProfile')}</Link>
                ...
                {!user ? (
                  <>
                    ...
                    <div className="pt-6 space-y-4">
                      <button onClick={() => { openLogin(); setMenuOpen(false); }} className="w-full py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-2xl font-bold shadow-lg">{t('login')}</button>
                      <button onClick={() => { openRegister(); setMenuOpen(false); }} className="w-full py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-2xl font-bold shadow-lg">{t('signup')}</button>
                    </div>
                  </>
                ) : profile?.role === "candidate" ? (
                  <>
                  ...
                  <>
                    <Link to="/post-job" onClick={() => setMenuOpen(false)} className="block w-full py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-2xl text-center font-bold shadow-lg">{t('postJob')}</Link>
